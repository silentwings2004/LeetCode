package LC3901_4200;
import java.util.*;
public class LC3935_PowerUpdateAfterKthLargestInsertionI {
    /**
     * You are given an integer array nums and an integer p.
     *
     * You are also given a 2D integer array queries, where each queries[i] = [vali, ki] and the difference between
     * consecutive ki values is always less than 10.
     *
     * For each query:
     *
     * Insert vali into nums.
     * Let x be the kith largest element in the current nums.
     * Update p to px % (10^9 + 7).
